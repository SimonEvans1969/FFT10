@extends('layouts.mehtpublic')

@section('viewName')
    Friends and Family Test Feedback Form
@endsection
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ($question_set ? 'meht.store' : 'meht.create'), 'method' => ($question_set ? 'POST' : 'GET'), 'role' => 'form', 'class' => 'needs-validation', 'id' => 'mehtentryform')) !!}
                        {!! csrf_field() !!}
                        <div class="form-group has-feedback row {{ $errors->has('FFT_DT') ?' has-error ' : '' }}">
                            ...
                            <div class="btn-group btn-group-toggle" data-toggle="buttons" aria-label="Time of Day">
